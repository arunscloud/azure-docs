...
| **Tasks** | Incident tasks are available in the Defender portal. <br><br>For more information, see [Streamline incident response using tasks in the Microsoft Defender portal](/defender-xdr/split-incidents-into-tasks.md). |
